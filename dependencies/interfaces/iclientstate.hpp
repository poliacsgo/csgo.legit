...
public:
	...
	bool send_file(const char* filename, unsigned int transferID) {
		using fn = bool(__thiscall*)(void*, const char*, unsigned int);
		return (*(fn * *)this)[43](this, filename, transferID);
	}
};
