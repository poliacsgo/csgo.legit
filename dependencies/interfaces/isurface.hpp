...
public:
	...
	void set_texture_file(int id, const char *filename, int hardwareFilter, bool forceReload) {
		...
		return (*(original_fn**)this)[36](this, id, filename, hardwareFilter, forceReload);
	}
	void get_texture_size(int id, int &wide, int &tall) {
		using original_fn = void(__thiscall*)(i_surface*, int, int&, int);
		return (*(original_fn**)this)[39](this, id, wide, tall);
	}
	...
	bool is_valid_textureid(int texture_id)
	{
