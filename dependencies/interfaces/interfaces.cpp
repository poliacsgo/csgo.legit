...
CGlowObjectManager* interfaces::m_pGlowObjManager = nullptr;
...
void interfaces::initialize( ) {
	...
	trace = reinterpret_cast<i_engine_trace*>(utilities::game::capture_interface("engine.dll", "EngineTraceClient"));
	...
	m_pGlowObjManager = *(CGlowObjectManager**)(utilities::pattern_scan(GetModuleHandleA("client_panorama.dll"), "0F 11 05 ? ? ? ? 83 C8 01") + 3);
